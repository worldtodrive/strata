...
export const TINT_LEVELS = {
	upstream: {
		...
		blurb: 'Their palette exactly: a white city with a colored minority.',
		share: 0.42, satCap: 0.30, neutralSat: 1.0, lightDrop: 0.00,
	},
	noticeable: {
		label: 'noticeable',
		blurb: 'More blocks take a hue, the grays become creams and bones, and the whole '
			+ 'band comes down enough for any of it to survive the fill light.',
		share: 0.58, satCap: 0.42, neutralSat: 2.4, lightDrop: 0.07,
	},
	bold: {
		label: 'bold',
		blurb: 'A colored city rather than a white one. Furthest from their brief and the '
	...
	white: {
		...
		blurb: 'Value only, no hue anywhere. The control — what the massing looks like with '
			+ 'the color argument removed entirely.',
...
export const SHADE_LEVELS = {
	off: {
		...
		blurb: 'Every face at full color. The record of what the page looked like before '
